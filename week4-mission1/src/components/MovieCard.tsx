// MovieCard 컴포넌트는 영화 정보를 카드 형태로 보여주는 UI 컴포넌트입니다.
...
export default function MovieCard({ movie }: MovieCardProps) {
    ...
    // useNavigate 훅을 사용해서 영화 카드를 클릭했을 때 상세 페이지로 이동할 수 있도록 함
  ...
  return (      
    <div 
        // 카드 컨테이너 설정
        onClick={(): void| Promise<void> => navigate(`/movies/details/${movie.id}`)}
